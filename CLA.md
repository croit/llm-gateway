...
v2.0, modified to name croit GmbH as the recipient and to permit relicensing.
...
license granted herein to Us and to recipients of software distributed by Us,
...
by You to Us for inclusion in, or documentation of, the Project (the "Work").

**"Submit"** means any form of electronic, verbal, or written communication
sent to Us or our representatives, including but not limited to communication on
electronic mailing lists, source code control systems, and issue tracking
systems that are managed by, or on behalf of, Us for the purpose of discussing
and improving the Work — for example pull requests and patches — but excluding
...
You further grant to Us the right to **license, relicense, and sublicense** Your
Contributions and derivative works thereof **under any license terms of Our
choosing, including open source, proprietary, and commercial licenses**, and to
do so **through multiple tiers of sublicensees**. You acknowledge and agree that
We may distribute the Work, including Your Contribution, under license terms
different from those currently applied to the Project.

For the avoidance of doubt: You retain all right, title, and interest in and to
Your Contributions. This Agreement does not assign or transfer ownership of Your
Contributions to Us; it grants the licenses described above.
...
by combination of Your Contribution with the Work to which You Submitted it.
...
such rights for Your Contributions to Us, or that Your employer has executed a
...
4.3 You represent that Your Contribution submissions include complete details of
...
personally aware, and conspicuously marking the work as **"Submitted on behalf
of a third-party: [named here]"**.

## 7. Developer Certificate of Origin

By Submitting a Contribution, You additionally certify the statements of the
**Developer Certificate of Origin, Version 1.1** (<https://developercertificate.org/>)
with respect to that Contribution, and You agree to add a `Signed-off-by` line
(`git commit --signoff`) to each commit in Your Contribution.
...
Contributions to the Project. Acceptance is recorded when You sign this Agreement
through the Project's CLA tooling on Your first pull request, or by signing
below.
...
> **Contributing on behalf of a company?** A Corporate Contributor License
> Agreement (covering all employees who contribute) is available — open an issue
> or contact <info@croit.io>.
