...
pub(super) struct ChatPage<'a> {
    ...
    pub effort: gateway_core::server::reasoning::Effort,
...
pub(super) fn render_chat_page(page: ChatPage<'_>) -> Html {
    ...
    let model_option_html: Vec<Html> = model_options
        ...
        .map(|(value, label)| {
            ...
            crate::pages::select_option(value, label, selected)
        })
        .collect();
...
fn render_composer_toolbar(
    session_id: &str,
    caps: &[CapabilityRow],
    effort: gateway_core::server::reasoning::Effort,
    lang: Lang,
) -> Html {
    html! {
...
fn render_effort_select(
    ...
    use gateway_core::server::reasoning::Effort;
...
fn effort_display_label(lang: Lang, effort: gateway_core::server::reasoning::Effort) -> String {
    use gateway_core::server::reasoning::Effort;
    t(
        lang,
        match effort {
