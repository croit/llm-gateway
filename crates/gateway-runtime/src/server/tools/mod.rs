...
pub struct ToolContext {
    ...
    pub db: gateway_core::server::db::Pool,
    ...
    pub s3: Option<std::sync::Arc<gateway_core::server::config::S3Config>>,
    ...
    pub geoip: Option<gateway_features::server::geoip::GeoIp>,
    ...
    pub indexer: Option<gateway_features::server::rag::worker::Indexer>,
...
impl ToolContext {
    ...
    pub fn for_test(db: gateway_core::server::db::Pool) -> Self {
        Self {
            user_id: "u".into(),
            roles: vec![],
            db,
