...
use gateway_core::server::db::mcp_catalog::{self, Connector};
use gateway_core::server::db::user_mcp::{self, Connection, ToolMode};
...
pub struct CompositeToolSource<'a> {
    ...
    comfyui: Option<&'a crate::server::comfyui_tool::ComfyuiToolSource>,
    user: &'a UserMcpLayer,
}
...
mod tests {
    ...
    use gateway_core::server::db::mcp_catalog::{AuthKind, Scope};
