...
/// Lets the RBAC resolver filter grants against the registry without depending
/// on it — see [`GrantableSet`](gateway_core::server::rbac::resolver::GrantableSet).
impl gateway_core::server::rbac::resolver::GrantableSet for ToolRegistry {
