...
/// Lets the RBAC resolver filter skill grants against the loaded set without
/// depending on it — see
/// [`GrantableSet`](gateway_core::server::rbac::resolver::GrantableSet).
impl gateway_core::server::rbac::resolver::GrantableSet for SkillRegistry {
